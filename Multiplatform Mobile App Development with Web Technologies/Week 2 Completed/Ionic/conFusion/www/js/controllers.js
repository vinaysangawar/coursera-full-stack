angular.module('conFusion.controllers', [])
  ...
  .controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'baseURL', '$ionicPopover', '$ionicListDelegate', 'favoriteFactory', '$ionicModal', function ($scope, $stateParams, menuFactory, baseURL, $ionicPopover, $ionicListDelegate, favoriteFactory, $ionicModal) {
    $scope.baseURL = baseURL;
    $scope.dish = {};
